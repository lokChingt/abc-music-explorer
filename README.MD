...
# Screenshots
- Home Page
![home_page](docs/screenshots/home_page.png)

- Search Page
![search_page](docs/screenshots/search_page.png)

- Playlist Page
![playlist_page](docs/screenshots/playlist_page.png)

- Statistics Page
![statistics_page](docs/screenshots/statistics_page.png)
...
**Step 1 - 5 only need to run once**
